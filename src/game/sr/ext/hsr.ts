...
const keymap = {
    set: <{ [key: string]: string }>{
        ...
        SacerdosRelivedOrdeal: "Sacerdos' Melodic Earrings",
        ScholarLostinErudition: "Scholar's Silver-Rimmed Monocle",
        HeroofTriumphantSong: "Hero of Triumphant Song",
        PoetofMourningCollapse: "Poet's Dill Wreath",
        WarriorGoddessofSunandThunder: "Warrior Goddess's Winged Helm",
